                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea onChange={handleChange} value={chapterData.remarks} name='remarks' className="form-control" placeholder="This is video is focused on basic introduction" id="techs"></textarea>
                                </div>
